...
#define PWM_PWM_SWITCH_SIGNAL_PRESENT      (1lu)
...
/* Timer/Counter Mode */
#define PWM_TC_PERIOD_VALUE                (1500lu)
#define PWM_TC_COMPARE_VALUE               (750lu)
#define PWM_TC_COMPARE_BUF_VALUE           (750lu)
#define PWM_TC_COMPARE_SWAP                (1lu)

/* PWM Mode */
#define PWM_PWM_PERIOD_VALUE               (10000lu)
#define PWM_PWM_PERIOD_BUF_VALUE           (500lu)
#define PWM_PWM_PERIOD_SWAP                (0lu)
#define PWM_PWM_COMPARE_VALUE              (100lu)
#define PWM_PWM_COMPARE_BUF_VALUE          (100lu)
